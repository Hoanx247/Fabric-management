...
#Region "THÔNG TIN CHUNG"
    ...
    Private Sub Filterdata_Stored()
        ...
        sbXMLString.Append("phanloai_ngaydem='" + ReplaceTextXML(txtphanloai_ngaydem.Text) + "' ")
        sbXMLString.Append(" />")
        sbXMLString.Append("</Root>")
        If ChkMeChuaSanXuat.CheckState = CheckState.Unchecked Then
            _dt = New KhoSanXuatDTO("[VpsXmlKhoSanXuat_MeNhuom_CongDoan_GetData_2021]", sbXMLString.ToString, "select")
        Else
            _dt = New KhoSanXuatDTO("[VpsXmlKhoSanXuat_MeNhuom_CongDoan_GetData_MeChuaSanXuat_2021_Test]", sbXMLString.ToString, "select")
        End If
...
#End Region
    ...
    Private Sub Super_Dgv_DataBindingComplete(ByVal sender As Object, ByVal e As GridDataBindingCompleteEventArgs)
        ...
        'End If
        '--
        Dim sortCols As GridColumn() = New GridColumn() {panel.Columns("phanloai_ngaydem"), panel.Columns("thutu_sanxuat"),
    ...
    Private Sub SuperGridControl1GetGroupDetailRows(ByVal sender As Object, ByVal e As GridGetGroupDetailRowsEventArgs)
        ...
        If panel.GroupColumns IsNot Nothing Then
            If e.GridGroup.Rows.Count > 0 Then
                ...
                If e.GridGroup.Column.Name.ToString.ToUpper = "mamay".ToString.ToUpper Then
...
#End Region
    ...
    Private Sub txt_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles _
        ...
        txtdonhang_F.KeyDown, txtmame_F.KeyDown, txtkhachhang_F.KeyDown, txtphanloai_ngaydem.KeyDown
    ...
    Private Sub ExportExcel()
        ...
        With moClsExcel
            ...
            ._Columns_1 = {"id", "mamay", "thutu_sanxuat", "-", "mahang", "loaihang", "macongdoan",
               ...
               "socay", "sokg", "tongcay", "tongkg", "ghichu", "mame_ghep", "dtngayin_phieusanxuat"}
            ._rangeExcel_Text = {}
...
#Region "AP THIET BI"
    Private Sub ToolStripButton_ApThietBi_Click(sender As Object, e As EventArgs) Handles ToolStripButton_ApThietBi.Click
        ...
        sbXMLString.Append("</Root>")
        '//
        _dt = New KhoSanXuatDTO("[VpsXmlKhoSanXuat_MeNhuom_congdoan_UpSet_2021]", sbXMLString.ToString, "update_mamay_2021")
        If SoDongChon > 0 Then
            dtControler.UPSET_XML(_dt)
            '//
            Call Filterdata_Stored()
    ...
    Private Sub UpdateDetails_update_ThietBi(ByVal rows As IEnumerable(Of GridElement))
        ...
        For Each item As GridElement In rows
            ...
            Else
                Dim row As GridRow = TryCast(item, GridRow)
                If row IsNot Nothing AndAlso row.Visible = True AndAlso row.Checked = True AndAlso row.IsDetailRow = False AndAlso row.Cells("mamay").Value.ToString.Length < 3 Then
                    SoDongChon += 1
                    sbXMLString.Append("<DATA ")
                    sbXMLString.Append("maid='" + ReplaceTextXML(row.Cells("maid").Value.ToString) + "' ")
...
#Region "AP THIET BI"
    ...
    Private Sub Super_Dgv_Click(sender As Object, e As EventArgs) Handles Super_Dgv.Click
