...
Public Class Stock_Thanhpham_Detail
...
#Region "LOAD DATA"
    Private Sub Filterdata_Stored()
        ...
        If ChkTon_KhoHoanTat.CheckState = CheckState.Checked Then
            _dt = New KhoSanXuatDTO("[VpsXmlKhoThanhPham_Chitiet_GetData_2021]", sbXMLString.ToString, "select")
        Else
            _dt = New KhoSanXuatDTO("[VpsXmlKhoThanhPham_Chitiet_GetData_2021_All]", sbXMLString.ToString, "select")
        End If
    ...
    Private Sub ExportExcel()
        ...
        With moClsExcel
            ...
            ._Columns_1 = {"id", "donhang", _colmahang, _colkhachhang, _colloaihang, _colkhovai, _colmetkg,
                _colMamau, _colTenMau, _colMame, "macay", "sokgtp", "somettp", "dongia", "thanhtien", "ghichu", "mamau_khach", "tenmau_khach", "mame_ghep"}
            ._rangeExcel_Text = {"K"}
