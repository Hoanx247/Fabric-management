...
Public Class frmNhap_Xuat_Ton_TPham_GiaVon
...
#Region "LOAD DATA"
    ...
    Private Sub Filterdata_Stored()
        ...
        sbXMLString.Append(" />")
        sbXMLString.Append("</Root>")
        _dt = New KhoMocNhapKhoDTO("[VpsXmlKhoMoc_NhapXuatTon_ThanhPham_GiaVon_GetData]", sbXMLString.ToString, "select")
...
#Region "EXCEL"
    ...
    Private Sub ExportExcel()
        ...
        With moClsExcel
            .strfileExcel_1 = "Report_NXT_TP.xls"
            ._rangeExcel = "A10"
            ._Columns_1 = {"id", "dtngaynhap_chungtu", "chungtunhap_khotp", "dtngayxuat",
                "chungtuxuat", _colmahang, _colkhachhang, _colloaihang, _colMamau, _colTenMau, _colMame, "dongia_von",
                "socaydk", "sokgdk", "sometdk", "ttdk", "socayntk", "sokgntk", "sometntk", "ttntk",
        "socayxtk", "sokgxtk", "sometxtk", "ttxtk", "socayck", "sokgck", "sometck", "ttck"}
            ._rangeExcel_Text = {}
            ._rangeExcel_number_0 = {"L", "M", "P", "Q", "T", "U", "X", "Y", "AB"}
            ._rangeExcel_number_1 = {"N", "O", "R", "S", "V", "W", "Z", "AA"}
