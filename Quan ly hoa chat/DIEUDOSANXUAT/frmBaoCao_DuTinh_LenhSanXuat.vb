...
Public Class frmBaoCao_DuTinh_LenhSanXuat
...
#End Region
    ...
    Private Sub Load_CongDoan()
        ...
        cboTencongdoan.SelectedIndex = -1
    End Sub
...
#Region "THÔNG TIN CHUNG"
    ...
    Private Sub Filterdata_Stored()
        ...
        sbXMLString.Append("tencongdoan='" + ReplaceTextXML(cboTencongdoan.Text) + "' ")
        sbXMLString.Append(" />")
        sbXMLString.Append("</Root>")
        If cboTencongdoan.SelectedIndex = 0 Or cboTencongdoan.SelectedIndex = -1 Then
            _dt = New KhoSanXuatDTO("[VpsXmlKhoSanXuat_DuTinhLSX_NXT]", sbXMLString.ToString, "select")
        ElseIf cboTencongdoan.SelectedIndex = 1 Then
            _dt = New KhoSanXuatDTO("[VpsXmlKhoSanXuat_DuTinhLSX_NXT]", sbXMLString.ToString, "select")
        End If
...
#Region "SUM"
    ...
    Dim _array_column As String() = {"tongcongdoan_dk", "tongthoigian_dk", "tongcongdoan_ntk", "tongthoigian_ntk",
...
#End Region
    ...
    Private Sub Super_Dgv_DataBindingComplete(ByVal sender As Object, ByVal e As GridDataBindingCompleteEventArgs)
        ...
        Dim columns As GridColumnCollection = panel.Columns
        'panel.AddGroup(panel.Columns("tenmay"))
        '--
        ...
        End If
        '--
        Dim sortCols As GridColumn() = New GridColumn() {panel.Columns("tenmay"), panel.Columns("macongdoan")}
    ...
    Private Sub SuperGridControl1GetGroupDetailRows(ByVal sender As Object, ByVal e As GridGetGroupDetailRowsEventArgs)
        ...
        If panel.GroupColumns IsNot Nothing Then
            If e.GridGroup.Rows.Count > 0 Then
                ...
                Next
                '///
                If e.GridGroup.Column.Name.ToString.ToUpper = "tenmay".ToString.ToUpper Then
                    e.GridGroup.Text = "MÁY: " & e.GridGroup.GroupValue.ToString.ToUpper
...
#End Region
    ...
    Private Sub txt_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles _
        ...
        txtnhanvien_F.KeyDown, txtmamay_F.KeyDown
...
#Region "LENH SAN XUAT"
    ...
    Private Sub ExportExcel_LenhSanXuat()
        ...
        With moClsExcel
            .strfileExcel_1 = "Report_TongHop_DTSX_NXT.xls"
            ._rangeExcel = "A11"
            ._Columns_1 = {"id", "tenmay", "tencongdoan", "thoigian", "tongcongdoan_dk", "tongthoigian_dk", "tongcongdoan_ntk", "tongthoigian_ntk",
        "tongcongdoan_xtk", "tongthoigian_xtk", "tongcongdoan_ck", "tongthoigian_ck"}
            ._rangeExcel_Text = {}
            ._rangeExcel_number_0 = {"D", "E", "F", "G", "H", "I", "J", "K"}
            ._rangeExcel_number_1 = {"L"}
