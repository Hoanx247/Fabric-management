...
Public Class KhoSanXuatDAL
    ...
    Public Function UPSET_XML(ByVal D As KhoSanXuatDTO) As Boolean
    ...
    Public Function SELECT_XML(ByVal D As KhoSanXuatDTO, ByVal panel As GridPanel) As DataTable
        ...
        Return dt
    End Function
    Public Function SELECT_XML_Datatable(ByVal D As KhoSanXuatDTO) As DataTable
        Dim dt As New DataTable
        Cls.SelectData_Stored_XML(D.sqlcommand, D.xml, D.Command)
        ' REPORT & ABORT ON ERRORS
        If Cls.HasException(True) = False Then
