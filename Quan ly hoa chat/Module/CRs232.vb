...
#Region "RS232"
Public Class Rs232_1 : Implements IDisposable
    '===================================================
    '
    '	Module				:	Rs232
...
#Region "Delegates"
    Public Delegate Sub CommEventHandler(ByVal source As Rs232_1, ByVal Mask As EventMasks)
#End Region
    ...
    Public Overloads Sub Write(ByVal Buffer As String)
        ...
        Dim oEnc As Encoding = System.Text.ASCIIEncoding.GetEncoding(28591)
        '-------------------------------------------------------------
...
#Region "Protected Routines"
    Protected Sub OnCommEventReceived(ByVal source As Rs232_1, ByVal mask As EventMasks)
        '===================================================
        '												©2003 www.codeworks.it All rights reserved
        '
...
Public Class Rs232_2 : Implements IDisposable
    '===================================================
    '
    '	Module				:	Rs232
    '	Description		:	Class for handling RS232 comunication with VB.Net
...
#Region "Delegates"
    Public Delegate Sub CommEventHandler(ByVal source As Rs232_2, ByVal Mask As EventMasks)
#End Region
...
#Region "Protected Routines"
    Protected Sub OnCommEventReceived(ByVal source As Rs232_2, ByVal mask As EventMasks)
        '===================================================
        '												©2003 www.codeworks.it All rights reserved
        '
        '	Description	:	Raises CommEvent
